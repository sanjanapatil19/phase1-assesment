...
public class Main {
public static final String DIR = "C:\\Users\\DELL\\documents";
	...
	public static void main(String[] args) throws IOException {
		...
		for(;;)
		{
			...
			System.out.println("*********WELCOME TO COMPANY LOCKER PVT LMT********* ");	
			System.out.println("Application Name: InfoWeb ");
			System.out.println("Developer Name: Sanjana Patil ");
